...
if("TRUE" STREQUAL "TRUE")
  set(filtering_SOURCE_PREFIX /home/robo/ros/src/filtering)
  set(filtering_DEVEL_PREFIX /home/robo/ros/devel)
  ...
  set(filtering_INSTALL_PREFIX /home/robo/ros/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'filtering' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'filtering' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robo/ros/src/filtering/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT filtering_NUM_DUMMY_TARGETS)
      set(filtering_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::filtering::wrapped-linker-option${filtering_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR filtering_NUM_DUMMY_TARGETS "${filtering_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::filtering::wrapped-linker-option${filtering_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND filtering_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${filtering_dep}_FOUND)
      find_package(${filtering_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${filtering_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
